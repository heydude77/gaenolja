		...
		<div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="${pageContext.servletContext.contextPath }${e.MAINIMAGE}" alt="Card image cap">
                <div class="card-body">
                	<c:choose>
                		<c:when test="${e.CHOICE == 1 }">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="${pageContext.servletContext.contextPath }/detail.do?no=${e.NO }"><button type="button" class="btn btn-sm btn-outline-secondary">View</button></a>
                    </div>
                    <small class="text-muted"><fmt:formatDate value="${e.REGDATE }" /></small>
                  </div>
                </div>
              </div>
			</div>
